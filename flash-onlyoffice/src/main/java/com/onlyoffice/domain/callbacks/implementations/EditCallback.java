...
package com.onlyoffice.domain.callbacks.implementations;

import com.onlyoffice.domain.callbacks.Callback;
import com.onlyoffice.domain.callbacks.Status;
import com.onlyoffice.domain.managers.callback.CallbackManager;
...
public class EditCallback implements Callback {
    ...
    public int handle(final Track body,
        ...
        if (action.getType().equals(com.onlyoffice.domain.models.enums
