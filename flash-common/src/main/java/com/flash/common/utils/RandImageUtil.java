...
public class RandImageUtil {
    ...
    public static final String KEY = "guquan";
    ...
    public static String generate(String resultCode) throws IOException {
        ...
        //写到指定位置
        ImageIO.write(image, "png", new File("C:\\Users\\zsp\\Desktop\\code.png"));

        return BASE64_PRE+base64;
    }

    public static void main(String[] args) throws IOException {
        String generate = generate("12DC");
...
//		graphics.setColor(getRandColor(100, 200)); // ---2
        ...
        for (int i = 0; i < 2; i++) {
            ...
            // 保证画在边框之内
            final int x = random.nextInt(WIDTH -10 - 1) + 1;
            final int y = random.nextInt(HEIGHT -10 - 1) + 1;
            final int xl = random.nextInt(60);
            final int yl = random.nextInt(60);
            graphics.drawLine(x, y, x + xl, y + yl);
        }
        // 取随机产生的认证码
...
//            graphics.setColor(Color.BLACK);
            Color fontColor = new Color(138, 185, 114);
