    ...
    public static String sensitize(SensitiveType sensitiveType, String value) throws IOException {
        switch (sensitiveType) {
            case COMMON:
                return value;
            case IDCARD_STRONG:
                return SensitiveInfoUtil.idCardNumStrong(value);
            case IDCARD_WEAK:
                return SensitiveInfoUtil.idCardNumWeak(value);
            case MOBILE_PHONE:
                return SensitiveInfoUtil.mobilePhone(value);
            case EMAIL:
                return SensitiveInfoUtil.email(value);
            case NAME:
                return SensitiveInfoUtil.name(value);
            default:
